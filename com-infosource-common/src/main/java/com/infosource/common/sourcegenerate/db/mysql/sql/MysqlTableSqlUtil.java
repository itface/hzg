package com.infosource.common.sourcegenerate.db.mysql.sql;

import com.infosource.common.sourcegenerate.util.ReflectUtils;
 ...
 */
public class MysqlTableSqlUtil {
...
//        sb.deleteCharAt(sb.length() - 2);
    ...
    public static void main(String[] args) {
        System.out.println(makeSql(User.class));
    }
}
